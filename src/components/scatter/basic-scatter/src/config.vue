  ...
  <div class="setting-panel-gui">
    ...
    >
      <template #default="slotProps">
        ...
        >
          <g-select
              v-model="slotProps.item.type"
              :data="[{ value: '普通', id: 'scatter' },{ value: '特效', id: 'effectScatter' }]"
          />
        </g-field>
        <g-field
            :level="2"
        ...
        >
          <g-input-number
              v-model="slotProps.item.symbolSize"
              :min="6"
              :step="1"
          />
        </g-field>
...
import { BasicScatterSeries, BasicScatter } from './basic-scatter'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const handleAddSeriesItem = () => {
      return new BasicScatterSeries(`系列${config.value.series.length + 1}`)
    }
