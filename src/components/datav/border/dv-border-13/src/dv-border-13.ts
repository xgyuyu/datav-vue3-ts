 ...
 * BorderBox
 */
export class VDvBorder13 extends DatavComponent {
  config = {
    img: 'https://files.pengxiaotian.com/bg-box/box1-1540-292.png',
  }
...
export const borderArr = [
  'https://files.pengxiaotian.com/bg-box/box1-1540-292.png',
  'https://files.pengxiaotian.com/bg-box/box2-1310-182.png',
  'https://files.pengxiaotian.com/bg-box/box3-1390-146.png',
  'https://files.pengxiaotian.com/bg-box/box4-1270-840.png',
  'https://files.pengxiaotian.com/bg-box/box5-1168-686.png',
  'https://files.pengxiaotian.com/bg-box/box6-1186-616.png',
  'https://files.pengxiaotian.com/bg-box/box7-580-742.png',
  'https://files.pengxiaotian.com/bg-box/box8-592-131.png',
  'https://files.pengxiaotian.com/bg-box/box9-524-282.png',
  'https://files.pengxiaotian.com/bg-box/box10-731-407.png',
  'https://files.pengxiaotian.com/bg-box/box11-492-335.png',
  'https://files.pengxiaotian.com/bg-box/box12-986-212.png',
  'https://files.pengxiaotian.com/bg-box/box13.png',
  'https://files.pengxiaotian.com/bg-box/box12-986-212.png',
  'https://files.pengxiaotian.com/bg-box/box14-689-232.png',
  'https://files.pengxiaotian.com/bg-box/box15.png',
  'https://files.pengxiaotian.com/bg-box/box16-116-115.png',
  'https://files.pengxiaotian.com/bg-box/box17.png',
]
